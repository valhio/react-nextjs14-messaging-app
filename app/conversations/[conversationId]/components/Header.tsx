    ...
    <div className="bg-white w-full flex border-b-[1px] sm:px-4 py-3 px-4 lg:px-6 justify-between items-center shadow-sm">
      <div className="flex gap-3 items-center">
        ...
        <div className="flex flex-col">
          ...
          <div className="text-sm font-lign text-gray-500">
            {statusText}
          </div>
        </div>
      </div>

      <HiEllipsisHorizontal size={32} onClick={()=>{}} className="text-gray-500 hover:text-gray-700 cursor-pointer transition duration-200 ease-in-out"/>
    </div>
  );
};
