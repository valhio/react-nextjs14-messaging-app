                        ...
                        <div className="flex flex-col justify-center items-center h-full">
                          <div className="flex flex-col items-center">
                            ...
                            <div className="mt-4 flex flex-col gap-2">
                              <button className="flex justify-center items-center gap-2 px-4 py-2 rounded-md bg-gray-100 hover:bg-gray-200 transition duration-200 ease-in-out">
                                <IoTrash size={22} />
                                <span className="text-sm">Delete chat</span>
                              </button>
                              {data.isGroup && (
                                <button className="flex justify-center items-center gap-2 px-4 py-2 rounded-md text-center bg-gray-100 hover:bg-gray-200 transition duration-200 ease-in-out">
